---
title: "Advanced: Progressive Disclosure, Bundled Scripts, and Subagent Orchestration"
---
...
- [Lesson 01: Progressive disclosure in practice](lesson-01-progressive-disclosure-in-practice/)
- [Lesson 02: Supporting scripts with ${CLAUDE_SKILL_DIR}](lesson-02-supporting-scripts/)
- [Lesson 03: Skills calling subagents](lesson-03-skill-calls-subagent/)
- [Lesson 04: Subagents preloading skills](lesson-04-subagent-uses-skills/)
- [Lesson 05: Skills orchestrating skills](lesson-05-skills-orchestrating-skills/)
- [Lesson 06: Context window mastery](lesson-06-context-window-mastery/)
- [Lesson 07: Hooks in skills](lesson-07-hooks-in-skills/)
- [Lesson 08: Plugins and distribution](lesson-08-plugins-and-distribution/)
- [Capstone: Code Quality Bot](capstone/)
